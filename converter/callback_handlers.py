...
responses = {
    ...
    "decoders": (
        ...
        "   - Example: <code>/octde 110145154154157</code> (Decodes '110145154154157' into 'Hello')\n\n"
    ...
    "credit_cards": (
        ...
        "   - Example: <code>/scr @PremiumNetworkTeam 100</code> (Scrapes 100 CC details from the specified chat)\n"
        "   - Target BIN Example: <code>/scr @PremiumNetworkTeam 460827 100</code> (Scrapes 100 CC details with BIN 460827 from the chat)\n\n"
    ...
    "downloaders": (
        ...
        "   - Example: <code>/pin https://pinterest.com/pin/example</code> (Downloads the specified Pinterest video)\n\n"
        "➢ <b>/in [Video URL]</b> - Download Instagram Reels.\n"
        "   - Example: <code>/in https://instagram.com/reel/example</code> (Downloads the specified Instagram reel)\n"
...
"education_utils": (
        ...
        "mail_tools": (
            ...
            "   - Example: <code>/scrmail @PremiumNetworkTeam 100</code> (Scrapes the first 100 messages from the specified group or channel for email-password pairs)\n\n"
            ">NOTE:\n"
        ...
        "random_address": (
            ...
            ">NOTE:\n"
            "1️⃣ Supported formats include either the country code (e.g., <code>US</code>, <code>BD</code>) or full country name (e.g., <code>United States</code>, <code>Bangladesh</code>).\n"
