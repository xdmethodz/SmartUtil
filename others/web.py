...
async def download_url(client, message):
    ...
    downloading_message = await message.reply_text("**Downloading Source Code.... This message will be deleted after downloading the source code**", parse_mode=ParseMode.MARKDOWN)

    downloader = urlDownloader()
    success = downloader.savePage(url)
